      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12 mt-10 px-6 xl:px-20">
        {projects.map((project, index) => (
          <a
            ...
            className="group relative block overflow-hidden rounded-2xl shadow-xl hover:shadow-[0_0_25px_rgba(120,0,255,0.4)] transition-all duration-300 transform hover:-translate-y-3">
            <Image
              src={project.image}
              alt={project.name}
