...
export const themes: Themes[] = [
  ...
  },
  {
    ...
    image: Government,
    description:
      'Armed with analytics, data scientists inform policy decisions, enhance public services, and ensure data-driven strategies to empower nations and thrive in the digital age.',
  },
];
